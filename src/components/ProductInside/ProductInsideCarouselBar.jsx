...
export default function ProductInsideCarouselBar({ type, data }){
    ...
    switch (type) {
        case 'premium':
            typeButton = <div className={`${styles.productType} ${styles.premium}`}>
                            <span className={styles.text}>Premium</span>
                            <PremiumIcon/>
                        </div>;
            break;
        case 'new':
            typeButton = <div className={`${styles.productType} ${styles.new} border-black dark:border-[#7d7d7d]`}>
                            <NewIcon/>
                            <span className={`${styles.text} text-black dark:text-light`}>Yeni</span>
                        </div>;
            break;
        default:
            typeButton = <></>;
                ...
                </Slider>
                {
                    data?.images?.length > 5 && (
                        <div className={styles.moreViewContainer}>
                            <div onClick={handleClick} className={styles.moreView}>+{data?.images.length - 5}</div>
                        </div>
                    )
                }
            </div>
